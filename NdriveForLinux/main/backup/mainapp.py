...
class MainFrame(wx.Frame):
    ...
    def initLayout(self):
        ...
        self.midSizer.Add(self.menuPanel, 0, wx.EXPAND|wx.ALL, 0)
        self.midSizer.Add(self.contentPanel, 0, wx.ALIGN_CENTER|wx.ALL, 12)
        self.sizer.Add(self.midSizer, 0, wx.ALIGN_CENTER|wx.ALL, 12)
    ...
    def setMidRightLayout(self):
        self.contentPanel = ContentPanel(self)
        pass
